...
if __name__ == "__main__":
    ...
    audio_file = "samples/sample_1_3.wav"
    audio_chunks, text_chunks = process_audio_file(audio_file)
    print("Step 1 done")
    ...
    print("Step 2 done", text_preds)
    # audio_preds = classify_audio_chunks(audio_chunks)
    # print("Step 3 done", audio_preds)

    # for i, (audio_pred, text_pred) in enumerate(zip(audio_preds, text_preds)):
    #     print(f"Chunk {i + 1} - Audio Emotion: {audio_pred}, Text Emotion: {text_pred}")
